...
public class ItemManager
{
    ...
    public static List<Item> InitItems()
    {
        ...
        {
            new Item("Dental 마스크",false, 5f),
            new Item("N95 마스크",false, 8.5f),
            new Item("일회용 장갑",false, 5f),
            new Item("라텍스 장갑",false, 7.5f),
            new Item("의료용 헤어캡",false, 10f),
            new Item("의료용 고글",false, 12.5f),
            new Item("AP 가운",false, 15f),
            new Item("Level C",false, 55f)
        };
    }
